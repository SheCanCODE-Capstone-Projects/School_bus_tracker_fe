  ...
  return (
    <div className="bg-white rounded-xl md:rounded-2xl shadow-md p-4 md:p-6 mb-4 md:mb-6">
      ...
      <div className="space-y-4 md:space-y-5">
        ...
        <div className="bg-blue-50 border border-gray-300 rounded-lg p-3 mb-2">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center mb-2 sm:mb-0">
              ...
              <span className="text-gray-700 text-sm md:text-base">Your Childs Bus</span>
            </div>
            <span className="bg-blue-100 text-blue-800 text-xs md:text-sm font-bold py-1 px-2 md:py-1 md:px-3 rounded-full self-start sm:self-auto">
              Bus 01
            </span>
          </div>
        </div>
        ...
        <div className="bg-[#10B981] rounded-lg md:rounded-xl p-3 md:p-4 mb-3 md:mb-4">
          {/* Status row */}
          <div className="flex items-center mb-1 md:mb-2">
            <span className="text-white font-bold mr-2 text-sm md:text-base">Status:</span>
            <div className="inline-flex items-center">
              <span className="w-2.5 h-2.5 md:w-3 md:h-3 bg-white rounded-full mr-1 md:mr-2"></span>
          ...
          <div className="flex items-center text-white">
            <svg className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
            </svg>
            <span className="font-medium text-xs md:text-sm">5th Ave & Park St</span>
          </div>
        </div>
