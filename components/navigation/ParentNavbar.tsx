...
function ParentNavbar() {
  return (
    <div>
        <nav className='font-sans bg-white flex sm:flex-row flex-col items-center justify-between gap-4 sm:gap-6 py-4 sm:py-6 px-4 sm:px-8 shadow-xs border-b border-gray-200'>
