  ...
  return (
    <div className="min-h-screen bg-gray-50"> 
      ...
      <div className="p-4 sm:p-8">
        ...
        {/* Bus Header */}
        <div className="bg-blue-100 text-black p-6 rounded-2xl mb-6  shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div className={`text-gray-700 px-4 py-2 w-full text-center rounded-full  text-sm ${busData.active ? "bg-green-500" : "bg-red-500"}`}>
              {busData.active ? "Status:Moving" : "Inactive"}
            </div>
          </div>
        </div>
